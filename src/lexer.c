...
register_t parse_register(const char* str) {
    if (strcasecmp(str, "ax") == 0) return REG_AX;
    if (strcasecmp(str, "bx") == 0) return REG_BX;
    if (strcasecmp(str, "cx") == 0) return REG_CX;
    if (strcasecmp(str, "dx") == 0) return REG_DX;
    if (strcasecmp(str, "si") == 0) return REG_SI;
    if (strcasecmp(str, "di") == 0) return REG_DI;
    if (strcasecmp(str, "bp") == 0) return REG_BP;
    if (strcasecmp(str, "sp") == 0) return REG_SP;
    if (strcasecmp(str, "cs") == 0) return REG_CS;
    if (strcasecmp(str, "ds") == 0) return REG_DS;
    if (strcasecmp(str, "es") == 0) return REG_ES;
    if (strcasecmp(str, "ss") == 0) return REG_SS;
    if (strcasecmp(str, "al") == 0) return REG_AL;
    if (strcasecmp(str, "ah") == 0) return REG_AH;
    if (strcasecmp(str, "bl") == 0) return REG_BL;
    if (strcasecmp(str, "bh") == 0) return REG_BH;
    if (strcasecmp(str, "cl") == 0) return REG_CL;
    if (strcasecmp(str, "ch") == 0) return REG_CH;
    if (strcasecmp(str, "dl") == 0) return REG_DL;
    if (strcasecmp(str, "dh") == 0) return REG_DH;
    return REG_NONE;
}
...
static token_t lexer_read_string(lexer_t* lexer) {
    ...
    } else {        // Check if it's a known instruction
